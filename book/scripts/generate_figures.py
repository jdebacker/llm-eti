...
def main():
    ...
    if 'implied_eti' in gs_mini.columns:
        plt.hist(gs_mini['implied_eti'], bins=50, alpha=0.7, label='GPT-4o-mini', color='orange')
    plt.xlabel('ETI')
    plt.ylabel('Frequency')
    ...
    if 'broad_income' in gs_4o.columns and 'implied_eti' in gs_4o.columns:
        ...
        plot_eti_by_income(combined_df, save_path=str(figures_dir / 'eti_by_income.png'))
        plt.close()
